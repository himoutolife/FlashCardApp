...
//nav bar with link to home, with name of deck
//shows deck name, deck description
//edit, study, add cards, and delete buttons with links to appropiate places
//each card is listed on page under cards heading, shows question and answer, has an edit button (eidt card screen link) and a delete button (with window.confirm() dialog box)
